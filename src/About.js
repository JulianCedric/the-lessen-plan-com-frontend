...
// to pass the final test, we need to account for: 
...
// so, we need to remove "_"

// remove "-" added to the loop 
...
function palindrome(str) {
  ...
  for (let i=0; i<strArr.length; i++) {
    if (strArr[i] === " " || strArr[i] === "_" || strArr[i] === "," || strArr[i] === "." || strArr[i] === "-") {
      strArr.splice(i, 1);
      // console.log(strArr);
      strArr.length - 1;
    }
...
function palindrome(str) {
  ...
  for (let i=0; i<strArr.length; i++) {
    if (strArr[i] === " " || strArr[i] === "_" || strArr[i] === "," || strArr[i] === "." || strArr[i] === "-" || strArr[i] === ":") {
      strArr.splice(i, 1);
      // console.log(strArr);
      strArr.length - 1;
    }
...
// *to be refactored after completing Reg Ex section*
